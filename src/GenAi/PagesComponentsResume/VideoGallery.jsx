...
const VideoGallery = ({ videos, handleVideoClick, selectedVideo, type }) => {
  return (
    <>
      <div className="flex w-full flex-col items-center justify-center">
        <div className="flex flex-row justify-between items-center text-center mb-1">
          <h3 className="text-primary text-xl">Candidate's Profiles</h3>
        </div>
      ...
      >
        <div
          className={`${
            ...
            selectedVideo !== null &&
            "border-primary lg:border-r border-opacity-20"
