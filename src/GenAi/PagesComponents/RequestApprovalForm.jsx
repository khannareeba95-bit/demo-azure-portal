        ...
        <div className="lg:w-[500px] md:w-[400px] w-[300px] max-h-[350px] md:max-h-[500px] xl:max-h-[700px] overflow-y-scroll custom-scrollbar overflow-x-hidden bg-white rounded-md shadow-xl p-5">
          ...
          <div className="flex w-full mt-10">
            ...
            <div class="flex flex-col w-[60%]">
              ...
              ></textarea>
              {error["description"] && (
                <p class="text-red-400">{error["description"]}</p>
              )}
            </div>
          </div>
          <div className="form-row flex w-full mt-5">
            <div class="w-[40%]">
              <label
                class="w-[40%] mr-[10px] text-sm md:text-base"
                htmlFor="consultingResponse"
              >
                Duration (in mins):
              </label>
            </div>
            ...
            <div class="flex flex-col w-[60%]">
              ...
              />
              {error["duration"] && (
                <p class="text-red-400">{error["duration"]}</p>
              )}
            </div>
          </div>
          ...
          <div className="form-row w-full mt-5 text-sm md:text-base">
            ...
            <div class="flex flex-col w-[60%]">
              ${Math.ceil((form.cost / 60) * (form.duration + 10))}
            </div>
          </div>
          <div className="form-row">
            <button
              className="submit-button hover:scale-105 text-sm md:text-base"
