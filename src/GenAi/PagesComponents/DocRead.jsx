...
const DocRead = ({ video }) => {
  ...
  return (
    <div className="lg:w-[60%] flex items-center flex-col gap-3 justify-center  w-full  bg-white  rounded-lg lg:h-[400px] h-[300px] lg:m-5 my-5 shadow-md">
      <img
...
export const PreviewModal = ({ isOpen, onClose, video }) => {
  const customStyles = {
    content: {
      top: "50%",
      left: "50%",
  ...
  return (
    <Modal
      ...
      style={customStyles}
    >
      <div className="sticky flex top-0 right-0 justify-end  w-full z-[999]  !p-0">
        <div className="">
          <RxCross2
            onClick={onClose}
